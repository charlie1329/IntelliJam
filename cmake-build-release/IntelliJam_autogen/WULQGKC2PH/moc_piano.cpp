...
QT_MOC_LITERAL(1, 6, 11), // "noteChanged"
QT_MOC_LITERAL(2, 18, 0), // ""
QT_MOC_LITERAL(3, 19, 7), // "newNote"
QT_MOC_LITERAL(4, 27, 11) // "updatePiano"

    },
    "Piano\0noteChanged\0\0newNote\0updatePiano"
};
...
void Piano::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->noteChanged((*reinterpret_cast< int(*)>(_a[1]))); break;
        case 1: _t->updatePiano((*reinterpret_cast< int(*)>(_a[1]))); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Piano::noteChanged)) {
                *result = 0;
                return;
            }
        }
...
const QMetaObject Piano::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_Piano.data,
      qt_meta_data_Piano,  qt_static_metacall, nullptr, nullptr}
};
...
// SIGNAL 0
void Piano::noteChanged(int _t1)
{
