...
model = Sequential()
model.add(LSTM(hidden_neurons, batch_input_shape=(n_batch,1,1),return_sequences=False, stateful=True))
...
for i in range(total_epochs):
	...
	model.save('D:/statefulLSTM2/statefulLSTMEpoch' + str(i) + '.h5')
...
model.save('D:/statefulLSTM2/statefulLSTM.h5')
